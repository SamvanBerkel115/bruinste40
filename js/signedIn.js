if (!window.bruin) var bruin = {
    ...
    set: {
        songs: function() {
            ...
            bruin.data.searchedSongs.forEach(function(song) {
                ...
                $(divSong).on('click tap', async function(evt) {
                    let divSong = this;
    ...
    create: {
        song: function(songObj) {
            ...
            $(iconDelete).on('click tap', async function(evt) {
                let btn = this;
    ...
    init: async function() {
        ...
        $('#btnOpenJouwBruine').on('click tap', function(evt) {
        ...
        $('#btnCloseJouwBruine').on('click tap', function(evt) {
